...
### Phase 3: Post-Endsem (The PGAT Architecture)
To solve these bottlenecks, I abandoned standard library GNNs and engineered **PGAT (Probability-Gated Attention Network)** a custom layer mathematically aligned with the IC/LT diffusion rules.
